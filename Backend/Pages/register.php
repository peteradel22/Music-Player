...
include('Web_Project\Backend\classes\User.php');
include('Web_Project\Backend\config\database.php');
...
if ($_POST && isset($_POST['register'])) {
    ...
    echo '<script>alert("' . $success . '"); location.href="http://localhost/Web_Project/Backend/Pages/register.php";</script>';
...
if($_POST && isset($_POST['login']) &&  isset($_POST['email']) &&  isset($_POST['pswd']))
{
    ...
    if($resuilt===true)
    {
        header('Location: http://localhost/Web_Project/Frontend/main.html ');
        exit;
    }
    else
    {
...
?>
                    ...
                    if (isset($errors)) 
                    {
                        echo '<script>alert("' . "Username or email address already in use" . '"); location.href="http://localhost/Web_Project/Backend/Pages/register.php";</script>';
